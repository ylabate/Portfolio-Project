...
export default function InventoryPage() {
  ...
  useEffect(() => {
    ...
    const handleScroll = () => {
      ...
      const threshold = 600; // Trigger fetch when 600px from bottom
  ...
  return (
    <>
      ...
      {/* Confirmation Modal (placed outside .page to prevent CSS transform conflicts with fixed positioning) */}
